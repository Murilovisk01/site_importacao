...
from .views import CustomLoginView, aprovar_membro, criar_sistema, criar_tarefa, criar_tipo_tarefa, dashboard_kanban, detalhes_tarefa, editar_sistema, editar_tarefa, editar_tipotarefa, excluir_tarefa, listar_sistemas, listar_tipotarefas, painel_equipe, registro_usuario, relatorio_equipe, remover_membro, tela_inicial, toggle_gerente
...
urlpatterns = [
    ...
    path('editar-tipo/<int:tipo_id>/', editar_tipotarefa, name='editar_tipotarefa'),
